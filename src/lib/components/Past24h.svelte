                                ...
                                {#each filteredGroupedFeeds[activeGroupName] as feed (getFeedItemId(feed))}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {#if feed.matched_preferences?.length}
                                                <span class="inline-block ml-1 text-primary" title={feed.matched_preferences.join(', ')}>★</span>
                                            {/if}
                                        </a>
                                    </li>
                                {/each}
                            ...
                            >
                                <div class="card-body p-5 lg:p-6">
                                    ...
                                    <div class="flex items-center gap-4 mb-4">
                                        ...
                                        {#if selectedFeedDesktop.matched_preferences?.length}
                                            <div class="flex flex-wrap gap-1">
                                                {#each selectedFeedDesktop.matched_preferences as pref}
